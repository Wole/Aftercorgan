/*
	...
	This will start and finish the Steel organ quest. It will buy stuff in mall. It will most probably 
...
//This switches to an +ítem fam, runs everything, and gathers the steel organ
void main(){
	print("Let's go!", "blue");
